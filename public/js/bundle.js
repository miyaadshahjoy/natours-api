...
var hideAlert = exports.hideAlert = function hideAlert() {
  ...
  alertEl === null || alertEl === void 0 || alertEl.parentElement.removeChild(alertEl);
};
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QmFhRL2T4jCYhmtVsziL7XpuoqeWyVFNYmZJcc1lLB9vFNefT73elHoMKZXavjV8uYiifGYbyN667QS5VhX2Ssz005T6wCx2p');
// FIXED:
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? '/api/v1/users/updateUserAccount' : '/api/v1/users/updatePassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
},{"./login":"login.js","./logout":"logout.js","./stripe":"stripe.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4415" + '/');
